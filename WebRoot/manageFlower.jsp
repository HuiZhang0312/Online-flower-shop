...
<html>
  ...
  <body>
	...
	<div id="body">
		<div class="about">
			...
			<thead>
				<td colspan="7" align="center">
					<b><font size="6">Flower</font></b>
				</td>
			</thead>
        <tr>
          <td width="100px" align="center"><b>id</b></td>
          <td width="100px" align="center"><b>flower</b></td>
          <td width="100px" align="center"><b>type</b></td>
        ...
        %>
        <tr>
          <td width="100px" align="center"><%=onerow.get("f_id")%></td>
          <td width="100px" align="center"><%=onerow.get("f_name")%></td>
          <td width="100px" align="center"><%=onerow.get("f_type")%></td>
          <td width="100px" align="center"><%=onerow.get("f_quantity")%></td>
          <td width="100px" align="center"><%=onerow.get("f_price")%></td>
          <td width="100px" align="center"><img src=<%= onerow.get("f_picture") %>></td>
          <td width="100px" align="center">
          	<form action="ShowSingleFlowerServlet?f_id=<%= onerow.get("f_id") %>" method="post">
          		<input type="submit" value="update" class="button" />
          	</form>
	        <form action="DeleteFlowerServlet?f_id=<%= onerow.get("f_id") %>" method="post">
  		...
  		<%}}%>
					<tr>
						<td colspan="7" align="center">
							...
							<a href="SearchFlowerServlet?nowpage=1">First</a>
							<%
								if (nowpage != 1) {
							%>
							<a href="SearchFlowerServlet?nowpage=<%=nowpage - 1%>">Previous</a>
							<%
								}
							%>
							<%
								if (nowpage != pages) {
							%>
							<a href="SearchFlowerServlet?nowpage=<%=nowpage + 1%>">Next</a>
							<%
								}
							%>
							<a href="SearchFlowerServlet?nowpage=<%=pages%>">Last</a>
						</td>
					</tr>
				</table>
		</div>
